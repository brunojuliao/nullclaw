...
pub fn build(b: *std.Build) void {
    ...
    const channels_raw = b.option(
        []const u8,
        "channels",
        "Channels list. Tokens: all|none|cli|telegram|discord|slack|whatsapp|matrix|mattermost|irc|imessage|email|lark|dingtalk|wecom|line|onebot|qq|maixcam|signal|nostr|web (default: all)",
    );
